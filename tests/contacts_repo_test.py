...
class TestContacts(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_contacts(self):
        body_1 = ContactRequest(
            first_name="Jay",
            last_name="Si",
            email="eple@gmail.com",
            phone_number="2",
            birthday=date(2001, 9, 12),
        )
        body_2 = ContactRequest(
            first_name="Walter",
            last_name="White",
            email="examfdfple@gmail.com",
            phone_number="1",
            birthday=date(1970, 1, 5),
        )
        await create_contact(
    ...
    async def test_search_contacts(self):
        query = "John"
        contacts = [
            Contact(id=i, user_id=self.current_user.id, first_name=f"John {i}")
            for i in range(1, 6)
        ]
